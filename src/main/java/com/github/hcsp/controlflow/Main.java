...
public class Main {
    ...
    public static String monthSeason(int month) {
        switch (month){
            case 1: return "1" + "月是春季";
            case 2: return "2" + "月是春季";
            case 3: return "3" + "月是春季";
            case 4: return "4" + "月是夏季";
            case 5: return "5" + "月是夏季";
            case 6: return "6" + "月是夏季";
            case 7: return "7" + "月是秋季";
            case 8: return "8" + "月是秋季";
            case 9: return "9" + "月是秋季";
            case 10: return "10" + "月是冬季";
            case 11: return "11" + "月是冬季";
            case 12: return "12" + "月是冬季";
            default: return "非法输入";
        }
